...
Tinflexsampler_sampler_from_c <- function(sexp_n, sexp_params, sexp_ib, sexp_c, sexp_rho, sexp_max_intervals) {
    .Call('_watson_Tinflexsampler_sampler_from_c', PACKAGE = 'watson', sexp_n, sexp_params, sexp_ib, sexp_c, sexp_rho, sexp_max_intervals)
}
